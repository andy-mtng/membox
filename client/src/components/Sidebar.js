    ...
    return (
        <div className="fixed h-full border-r border-gray-300 px-6 flex flex-col justify-between ml-auto w-55">
            <div className="flex flex-col gap-5">
                ...
                <Link className={currentPage === "/memories" ? sideBarItemStyles + " text-black" : sideBarItemStyles + " text-gray-400"} to="/memories">
                ...
                <Link className={currentPage === "/profile" ? sideBarItemStyles + " text-black" : sideBarItemStyles + " text-gray-400"} to="/profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
            ...
            <Link className="flex gap-2 items-center mb-8 rounded-md hover:bg-gray-100" onClick={handleLogoutClick}>
